...
void component_init(component_t g);
void component_insert_vertex(component_t g, vertex_t v);
vertex_t component_find_vertex_by_id(component_t g, vertexid_t id);
edge_t component_find_edge_by_ids(
	component_t g, vertexid_t id1, vertexid_t id2);
void component_insert_edge(component_t g, edge_t e);
void component_print(component_t g, int with_tuples);
